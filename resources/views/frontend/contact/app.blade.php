...
@section("title", "Testimonials | Furnish")
            ...
            <div class="container">
                <div class="row g-5 align-items-start">
                    ...
                    <div class="col-md-4">
                        ...
                        <p class="text-muted mb-4">Whether you have a question about our products, need assistance, or just
                            want to talk furniture — we’re here for you.</p>

                        <div class=" d-flex align-items-start mb-3">
                            <i class="bi bi-geo-alt-fill me-3 text-secondary"></i>
                            <div>
                                <h5 class="fw-semibold mb-1 text-uppercase text-xs">Address</h5>
                                <p class="text-muted mb-0">123 Furniture Street, Mumbai, India</p>
                            </div>
                        </div>
                        ...
                        <div class=" d-flex align-items-start mb-3">
                            ...
                            <div>
                                <h5 class="fw-semibold mb-1 text-uppercase text-xs">Email</h6>
                                    <p class="text-muted mb-0 ">support@furnish.com</p>
                            </div>
                        </div>
                        ...
                        <div class=" d-flex align-items-start mb-3">
                            ...
                            <div>
                                <h5 class="fw-semibold mb-1 text-uppercase text-xs">Phone</h6>
