...
@section("content")
    <main>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xxl-8 col-12 ">
                        <div class="swiper-container swiper swiper-pagination-light " id="swiper-6" data-pagination-type=""
                            data-speed="800" data-space-between="100" data-pagination="true" data-navigation="true"
                            data-autoplay="true" data-effect="slide" data-autoplay-delay="3000"
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide px-md-8 ">
                                    <div class="position-relative text-center">
                                        ...
                                        <img src="{{asset('assets/images/slider/slider-img-2.png')}}" alt=""
                                            class="img-fluid my-5 my-lg-0">
                                        ...
                                        <div
                                            class="position-absolute top-md-65 top-75 start-50 translate-middle-x mt-lg-9 ">
                                            <p class="d-none d-lg-block">Comfortable and stylish sofa for your home
                                                office.</p>
                                ...
                                <div class="swiper-slide px-md-8 ">
                                    <div class="position-relative text-center">
                                        <img src="{{ asset('assets/images/slider/slider-img-1.png')}}" alt=""
                                            class="img-fluid my-5 my-lg-0">
                                        <div class="text-center position-absolute top-0 start-0 px-lg-11   ">
                                ...
                                <div class="swiper-slide px-md-8 ">
                                    <div class="position-relative text-center">
                                        ...
                                        <img src="{{ asset('assets/images/slider/slider-img-3.png')}}" alt=""
                                            class="img-fluid my-5 my-lg-0">
                                        <div class="text-center position-absolute top-0 start-0 px-lg-11   ">
                                        ...
                                        <div
                                            class="position-absolute top-md-65 top-75 start-50 translate-middle-x mt-lg-9 ">
                                            <p class="d-none d-lg-block">Experience the elegance of timeless
                                                craftsmanship with our Sofa. </p>
                    ...
                    <div class="col-lg-12 mb-8">
                        <div class="d-flex flex-column flex-md-row align-items-md-end justify-content-md-between gap-4">
                            ...
                            <div class="col-sm-5">
                                ...
                                <p class="mb-0 lead">We are inspired by the realities of life today, in which
                                    traditional divides
                                    between
                        ...
                        <div class="swiper-container swiper" id="swiper-3" data-pagination-type="bullets" data-speed="400"
                            ...
                            <div class="swiper-wrapper pb-10">
                                <div class="swiper-slide">
                                    <div>
                                        <a href="#"><img src="{{ asset('assets/images/product-img-1.jpg')}}" alt=""
                                                class="img-fluid"></a>
                                ...
                                <div class="swiper-slide">
                                    <div>
                                        <a href="#"><img src="{{ asset('assets/images/product-img-2.jpg')}}" alt=""
                                                class="img-fluid"></a>
                                        <div class="text-center">
                                            <h3 class="mt-3 h5">
                                                <a href="#">
                                ...
                                <div class="swiper-slide">
                                    <div>
                                        <a href="#"><img src="{{ asset('assets/images/product-img-5.jpg')}}" alt=""
                                                class="img-fluid"></a>
                                        <div class="text-center">
                                            <h3 class="mt-3 h5">
                                                <a href="#">
                                                    High Back Boss Chair</a>
                                            </h3>
                                            <div class="">
                                ...
                                <div class="swiper-slide">
                                    <div>
                                        <a href="#"><img src="{{ asset('assets/images/product-img-6.jpg')}}" alt=""
                                                class="img-fluid"></a>
                                        <div class="text-center">
                                            <h3 class="mt-3 h5">
                                                <a href="#">
                                ...
                                <div class="swiper-slide">
                                    <div>
                                        <a href="#"><img src="{{ asset('assets/images/product-img-3.jpg')}}" alt=""
                                                class="img-fluid"></a>
                                        <div class="text-center">
                                            <h3 class="mt-3 h5">
                                                <a href="#">
                            ...
                            <!-- Add Navigation -->
                            <div
                                class="swiper-navigation position-absolute start-50 translate-middle-x bottom-0 mb-4 d-none d-lg-block">
        ...
        <!--New arrival end-->
        <section
            style="background: url(./assets/images/couch-with-cushions-glass-table.jpg)no-repeat; background-size: cover; background-position: center;"
            class="py-lg-11 py-6">
            <div class="container">
