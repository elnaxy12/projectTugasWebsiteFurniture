  ...
  <ul class="navbar-nav flex-column  ">
    ...
    <li class="nav-item dropdown">
      ...
      <ul class="dropdown-menu flex-column">
        ...
        <li class="nav-item">
          <a class="nav-link" href="{{ route('error') }}">404 Error</a>
        </li>
      </ul>
    </li>
    <!-- Nav item -->
...
<div class="offcanvasNav offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample"
  ...
  <div class="offcanvas-body p-0">
    <ul class="navbar-nav flex-column  ">
      <!-- Nav item -->
      <li class="nav-item">
        <a class="nav-link" href="{{ route('dashboard') }}"><span class="nav-icon"><svg
      ...
      <!-- Nav item -->
      <li class="nav-item">
        <a class="nav-link" href="@@webRoot/dashboard/analytics">
      ...
      <!-- Nav item -->
      <li class="nav-item">
        <a class="nav-link" href="@@webRoot/dashboard/ecommerce"><span class="nav-icon"><svg
              xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
              stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"
              class="icon icon-tabler icons-tabler-outline icon-tabler-shopping-bag">
              <path stroke="none" d="M0 0h24v24H0z" fill="none" />
      ...
      <!-- Nav item -->
      <li class="nav-item">
        <a class="nav-link" href="@@webRoot/dashboard/crm"><span class="nav-icon"><svg
              xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
              stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"
      ...
      <!-- Nav item -->
      <li class="nav-item">
        <a class="nav-link" href="@@webRoot/dashboard/finance"><span class="nav-icon"><svg
              xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
              stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"
      ...
      <!-- Nav item -->
      <li class="nav-item">
        <a class="nav-link" href="@@webRoot/dashboard/blog"><span class="nav-icon"><svg
              xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
              stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"
      ...
      <!-- Nav item -->
      <li class="nav-item">
        <a class="nav-link" href="@@webRoot/dashboard/file"><span class="nav-icon"><svg
              xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
              stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"
      ...
      <!-- Nav item -->
      <li class="nav-item">
        <a class="nav-link" href="@@webRoot/apps/calendar">
          <span class="nav-icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
              stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"
      ...
      <!-- Nav item -->
      <li class="nav-item">
        <a class="nav-link" href="@@webRoot/apps/chat-app">
          <span class="nav-icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
              stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"
      ...
      <!-- Nav item -->
      <li class="nav-item">
        <a class="nav-link" href="@@webRoot/apps/kanban">
          <span class="nav-icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
              stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"
      ...
      <li class="nav-item dropdown">
        ...
        <ul class="dropdown-menu flex-column">
          <li class="nav-item">
            <a class="nav-link" href="@@webRoot/apps/email/mail">Inbox</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="@@webRoot/apps/email/mail-details">Email Detail</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="@@webRoot/apps/email/compose">Compose</a>
          </li>
        </ul>
      </li>
      <!-- Nav item -->
      <li class="nav-item dropdown">
        ...
        <ul class="dropdown-menu flex-column">
          <li class="nav-item">
            <a class="nav-link" href="@@webRoot/apps/e-commerce/ecommerce-products">Products</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="@@webRoot/apps/e-commerce/ecommerce-products-details">Product Detail</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="@@webRoot/apps/e-commerce/ecommerce-product-edit">Add Product</a>
          </li>

          <li class="nav-item">
            <a class="nav-link" href="@@webRoot/apps/e-commerce/ecommerce-cart">Shopping cart</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="@@webRoot/apps/e-commerce/ecommerce-checkout">Checkout</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="@@webRoot/apps/e-commerce/ecommerce-customer">Customer</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="@@webRoot/apps/e-commerce/ecommerce-seller">Seller</a>
          </li>
        </ul>
      </li>
      <!-- Nav item -->
      <li class="nav-item dropdown">
        ...
        <ul class="dropdown-menu flex-column">
          <li class="nav-item">
            <a class="nav-link" href="@@webRoot/apps/order/order-list">List</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="@@webRoot/apps/order/order-details">Details</a>
          </li>
      ...
      <li class="nav-item dropdown">
        ...
        <ul class="dropdown-menu flex-column">
          <li class="nav-item">
            <a class="nav-link" href="@@webRoot/apps/project/project-grid">Grid</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="@@webRoot/apps/project/project-list">List</a>
          </li>
          <li class="dropdown-submenu">
            <a class="nav-link dropdown-toggle" href="#!" role="button" data-bs-toggle="dropdown"
            ...
            <ul class="dropdown-menu">
              <li class="nav-item">
                <a class="nav-link" href="@@webRoot/apps/project/project-overview">Overview</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="@@webRoot/apps/project/project-task">Task</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="@@webRoot/apps/project/project-budget">Budget</a>
              </li>

              <li class="nav-item">
                <a class="nav-link" href="@@webRoot/apps/project/project-files">Files</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="@@webRoot/apps/project/project-team">Team</a>
              </li>
            </ul>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="@@webRoot/apps/project/add-project">Create Project</a>
          </li>
        </ul>
      </li>
      <!-- Nav item -->
      <li class="nav-item dropdown">
        ...
        <ul class="dropdown-menu flex-column">
          <li class="nav-item">
            <a class="nav-link" href="@@webRoot/apps/crm/crm-contacts">Contacts</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="@@webRoot/apps/crm/crm-company">Company</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="@@webRoot/apps/crm/deals">Deals</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="@@webRoot/apps/crm/deals-single">Deals Single</a>
          </li>
        </ul>
      </li>
      <!-- Nav item -->
      <li class="nav-item dropdown">
        ...
        <ul class="dropdown-menu flex-column">
          <li class="nav-item">
            <a class="nav-link" href="@@webRoot/apps/invoice/invoice-list">List</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="@@webRoot/apps/invoice/invoice-detail">Detail</a>
          </li>
      ...
      <li class="nav-item dropdown">
        ...
        <ul class="dropdown-menu flex-column">
          <li class="nav-item">
            <a class="nav-link" href="@@webRoot/apps/profile/profile-overview">Overview</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="@@webRoot/apps/profile/profile-project">Project</a>
          </li>

          <li class="nav-item">
            <a class="nav-link" href="@@webRoot/apps/profile/profile-team">Team</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="@@webRoot/apps/profile/profile-followers">Followers</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="@@webRoot/apps/profile/profile-activity">Activity</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="@@webRoot/apps/profile/profile-settings">Settings</a>
          </li>
        </ul>
      </li>
      <!-- Nav item -->
      <li class="nav-item dropdown">
        ...
        <ul class="dropdown-menu flex-column">
          <li class="nav-item">
            <a class="nav-link" href="@@webRoot/apps/blog/blog-list">List</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="@@webRoot/apps/blog/blog-post-detail">Details</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="@@webRoot/apps/blog/create-blog-post">Create</a>
          </li>
        </ul>
      </li>
      ...
      <li class="nav-item dropdown">
        ...
        <ul class="dropdown-menu flex-column">
          <li class="nav-item">
            <a class="nav-link" href="@@webRoot/apexchart/bar">Bar</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="@@webRoot/apexchart/line">Line</a>
          </li>

          <li class="nav-item">
            <a class="nav-link" href="@@webRoot/apexchart/pie">Pie</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="@@webRoot/apexchart/radialbar">Radialbar</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="@@webRoot/apexchart/radar">Radar</a>
          </li>

          <li class="nav-item">
            <a class="nav-link" href="@@webRoot/apexchart/polararea">Polararea</a>
          </li>
        </ul>
      </li>
      <!-- Nav item -->
      <li class="nav-item dropdown">
        <a class="nav-link" href="@@webRoot/components/components" role="button">
          <span class="nav-icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
              stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"
      ...
      <!-- Nav item -->
      <li class="nav-item">
        <a class="nav-link" href="@@webRoot/docs/index">
          <span class="nav-icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
              stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"
