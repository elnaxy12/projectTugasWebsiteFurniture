...
<body>
        ...
        <div class="row mb-6 g-6">
          ...
          <div class="col-xl-4 col-lg-6">
            ...
            <div class="card card-lg">
              <!-- card body -->
              <div class="card-body">
                <div class="mb-4 d-flex justify-content-between align-items-center py-2">
                  <div>
                    <h5 class="mb-1">Ideas for You</h5>
                  </div>
                  <!-- swiper navigation-->
                  <div class="swiper-navigation d-flex gap-2">
                    <div class="swiper-button-next1 position-static ms-0"><svg xmlns="http://www.w3.org/2000/svg"
                        width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                        stroke-linecap="round" stroke-linejoin="round"
                        class="lucide lucide-chevron-left-icon lucide-chevron-left">
                        <path d="m15 18-6-6 6-6" />
                      </svg></div>
                    <div class="swiper-button-prev1 position-static ms-0"><svg xmlns="http://www.w3.org/2000/svg"
                        width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                        stroke-linecap="round" stroke-linejoin="round"
                  ...
                  <tbody>
                      ...
                      <td>
                        <div>
                          <a href="#!" class="d-flex align-items-center gap-2 text-inherit">
                            <img src="{{ asset('assets/images/ecommerce/product-1.jpg') }}" alt="product"
                    ...
                    <tr>
                      <td>
                        <div>
                          <a href="#!" class="d-flex align-items-center gap-2 text-inherit">
                            <img src="{{ asset('assets/images/ecommerce/product-2.jpg') }}" alt="product"
                              class="rounded" width="40" />
                    ...
                    <tr>
                      <td>
                        <div>
                          <a href="#!" class="d-flex align-items-center gap-2 text-inherit">
                            <img src="{{ asset('assets/images/ecommerce/product-3.jpg') }}" alt="product"
                              class="rounded" width="40" />
                    ...
                    <tr>
                      <td>
                        <div>
                          <a href="#!" class="d-flex align-items-center gap-2 text-inherit">
                            <img src="{{ asset('assets/images/ecommerce/product-4.jpg') }}" alt="product"
                              class="rounded" width="40" />
                    ...
                    <tr>
                      <td>
                        <div>
                          <a href="#!" class="d-flex align-items-center gap-2 text-inherit">
                            <img src="{{ asset('assets/images/ecommerce/product-5.jpg') }}" alt="product"
                              class="rounded" width="40" />
                    ...
                    <tr>
                      <td>
                        <div>
                          <a href="#!" class="d-flex align-items-center gap-2 text-inherit">
                            <img src="{{ asset('assets/images/ecommerce/product-6.jpg') }}" alt="product"
                              class="rounded" width="40" />
  ...
  <script src="{{ asset('assets/js/vendors/jsvectormap.min.js') }}"></script>
  <script src="{{ asset('assets/js/vendors/world.js') }}"></script>
  <script src="{{ asset('assets/js/vendors/world-merc.js') }}"></script>
  <script src="{{ asset('assets/js/vendors/apexcharts.min.js') }}"></script>
  <script src="{{ asset('assets/js/vendors/chart.js') }}"></script>
  <script src="{{ asset('assets/js/vendors/choices.min.js') }}"></script>
