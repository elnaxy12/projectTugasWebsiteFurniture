...
@section('content')
    <main>
        ...
        <section class="py-lg-8 py-5">
            <div class="container">
                <div class="row align-items-center g-5 mx-lg-8">
                    <div class="col-md-6">
                        <img src="./assets/images/about.jpg" alt="Living room" class="img-fluid ">
                    </div>
                    <div class="col-md-6">
                        <div class="ms-lg-8">
                            <h2 class=" mb-3">Our Mission</h2>
                            <p class="text-muted">
                                At Furnish, our mission is to bring timeless style and comfort to every home. We combine
                                craftsmanship, innovation, and sustainability to create furniture that lasts for
                                generations.
                            </p>
                            <p class="text-muted">
                                From sourcing eco-friendly materials to perfecting every curve and detail, we are
                                dedicated to creating pieces that bring harmony and functionality to your living space.
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-4">
                        <div class="card rounded-0 border-0 shadow-sm h-100 p-4">
                            <div class="card-body">
                                ...
                                <p class="text-muted">We use responsibly sourced materials to ensure our furniture
                                    supports a greener planet.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card rounded-0 border-0 shadow-sm h-100 p-4">
                            <div class="card-body">
                                ...
                                <p class="text-muted">Every piece undergoes rigorous testing to guarantee durability and
                                    comfort.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card rounded-0 border-0 shadow-sm h-100 p-4">
                            <div class="card-body">
                                ...
                                <p class="text-muted">Our designs blend modern aesthetics with functional elegance for
                                    every home.</p>
                            </div>
                        </div>
                    </div>
        ...
        <section class="py-lg-8 py-5">
            <div class="container text-center">
                <h2 class="mb-8">Meet Our Team</h2>
                <div class="row g-4">
                    <div class="col-6 col-md-3">
                        <div class="mx-md-8">
                            <img src="./assets/images/avatar/avatar-1.jpg" class="rounded-circle img-fluid mb-3"
                                alt="Team member">
                        </div>
                        <div class="lh-1">
                    ...
                    <div class="col-6 col-md-3">
                        <div class="mx-md-8">
                            <img src="./assets/images/avatar/avatar-2.jpg" class="rounded-circle img-fluid mb-3"
                                alt="Team member">
                        </div>
                        <div class="lh-1">
                            <h3 class=" mb-1 h5">
                    ...
                    <div class="col-6 col-md-3">
                        <div class="mx-md-8">
                            <img src="./assets/images/avatar/avatar-3.jpg" class="rounded-circle img-fluid mb-3"
                                alt="Team member">
                        </div>
                        <div class="lh-1">
                    ...
                    <div class="col-6 col-md-3">
                        <div class="mx-md-8">
                            <img src="./assets/images/avatar/avatar-4.jpg" class="rounded-circle img-fluid mb-3"
                                alt="Team member">
                        </div>
                        <div class="lh-1">
